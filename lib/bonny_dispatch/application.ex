defmodule BonnyDispatch.Application do
  ...
  def start(_type, env: env) do
    opts = [strategy: :one_for_one, name: BonnyDispatch.Supervisor]
  ...
  defp children(env) do
    [
      {BonnyDispatch.Operator, conn: BonnyDispatch.K8sConn.get!(env)}
    ]
  end
end
